   ...
   <section id="mantenimiento" >
    ...
    <div class="row section-head">
      <div class="twelve columns">
           ...
           <h1 style="colour:ff0045">ELIMINAR AUXILIAR<span></span></h1>

           <hr>

           <p>Aqui usted podra ELIMINAR un auxiliar del centro educativo.
    ...
    <div class="row form-section">    
        ...
        <form action="borrarAuxiliar.php" method="post">
            ...
            <!-- boton de registro -->
          <input class="btn btn-danger" type="submit" name="submit" value="Eliminar Auxiliar" />
