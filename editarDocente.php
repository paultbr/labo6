   ...
   <section id="mantenimiento" >
    ...
    <div class="row section-head">
      <div class="twelve columns">
           ...
           <h1 style="colour:ff0045">EDITAR DOCENTE<span></span></h1>

           <hr>

           <p>Aqui usted podra EDITAR los datos de un nuevo docente del centro educativo.
...
-->
            ...
            <!-- boton de registro -->
          <input class="btn btn-danger" type="submit" name="submit" value="Actualizar Docente" />
