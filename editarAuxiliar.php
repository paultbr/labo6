   ...
   <section id="mantenimiento" >
    ...
    <div class="row section-head">
      <div class="twelve columns">
           ...
           <h1 style="colour:ff0045">EDITAR AUXILIAR<span></span></h1>

           <hr>

           <p>Aqui usted podra EDITAR un nuevo auxiliar del centro educativo.
    ...
    <div class="row form-section">    
        ...
        <form action="editarAuxiliar.php" method="post">
...
-->
            ...
            <!-- boton de registro -->
          <input class="btn btn-danger" type="submit" name="submit" value="Actualizar Datos del Auxiliar" />
