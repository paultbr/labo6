   ...
   <section id="mantenimiento" >
    ...
    <div class="row section-head">
      <div class="twelve columns">
           ...
           <h1 style="colour:ff0045">EDITAR ALUMNO<span></span></h1>

           <hr>

           <p>Aqui usted podra EDITAR un nuevo alumno del centro educativo.
    ...
    <div class="row form-section">    
        ...
        <form action="editarAlumno.php" method="post">
            ...
            <div>
                <label><h3>Grado</h3></label>
                <input type="text" name="grado" class="form-control" placeholder="Ingresar Grado" />
            </div>

            <div>
                <label><h3>Seccion</h3></label>
                <input type="text" name="seccion" class="form-control" placeholder="Ingresar Seccion" />
            </div>

            <div>
                <label><h3>DNI del padre o apoderado</h3></label>
                <input type="text" name="dni_apoderado" class="form-control" placeholder="Ingresar ID del apoderado" />
            </div>

            <div>
                <label><h3>Fecha de ingreso</h3></label>
                <input type="datetime-local" name="fecha_ingreso" id="fechaingreso" style="border:solid 1px #ff0000;">
            </div>
            ...
            <!-- boton de registro -->
          <input class="btn btn-danger" type="submit" name="submit" value="Actualizar Datos Alumno" />
