   ...
   <section id="mantenimiento" >
    ...
    <div class="row section-head">
      <div class="twelve columns">
           ...
           <h1 style="colour:ff0045">EDITAR ADMINISTRADOR<span></span></h1>

           <hr>

           <p>Aqui usted podra EDITAR los datos del administrador del centro educativo.
...
-->
            ...
            <!-- boton de registro -->
          <input class="btn btn-danger" type="submit" name="submit" value="Actualizar Administrador" />
