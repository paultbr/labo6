   ...
   <section id="mantenimiento" >
    ...
    <div class="row section-head">
      <div class="twelve columns">
           ...
           <h1 style="colour:ff0045">REGISTRAR ADMINISTRADOR<span></span></h1>

           <hr>

           <p>Aqui usted podra REGISTRAR un nuevo administrador del centro educativo.
    ...
    <div class="row form-section">    
        ...
        <form action="insertarAdministrador.php" method="post">
...
-->
            ...
            <!-- boton de registro -->
          <input class="btn btn-danger" type="submit" name="submit" value="Registrar Administrador" />
