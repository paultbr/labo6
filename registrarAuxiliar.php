   ...
   <section id="mantenimiento" >
    ...
    <div class="row section-head">
      <div class="twelve columns">
           ...
           <h1 style="colour:ff0045">REGISTRAR AUXILIAR<span></span></h1>

           <hr>

           <p>Aqui usted podra REGISTRAR un nuevo auxiliar del centro educativo.
...
-->
            ...
            <!-- boton de registro -->
          <input class="btn btn-danger" type="submit" name="submit" value="Registrar Auxiliar" />
